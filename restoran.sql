...
INSERT INTO djelatnik VALUES
    ...
    (31, 31, "64084659928", STR_TO_DATE('12.05.1999.', '%d.%m.%Y.'), STR_TO_DATE('18.06.2015.', '%d.%m.%Y.'), 3),
    (32, 32, "62672005876", STR_TO_DATE('05.05.1995.', '%d.%m.%Y.'), STR_TO_DATE('17.07.2017.', '%d.%m.%Y.'), 4),
    (33, 33, "25977293327", STR_TO_DATE('12.05.2000.', '%d.%m.%Y.'), STR_TO_DATE('20.11.2020.', '%d.%m.%Y.'), 5),
    (34, 34, "19279229706", STR_TO_DATE('16.03.1994.', '%d.%m.%Y.'), STR_TO_DATE('19.09.2019.', '%d.%m.%Y.'), 6),
    (35, 35, "02392747164", STR_TO_DATE('07.10.1990.', '%d.%m.%Y.'), STR_TO_DATE('16.03.2015', '%d.%m.%Y.'), 6),
    (36, 36, "22231425931", STR_TO_DATE('25.07.1988.', '%d.%m.%Y.'), STR_TO_DATE('17.04.2018.', '%d.%m.%Y.'), 7),
    (37, 37, "14356583214", STR_TO_DATE('13.12.1991.', '%d.%m.%Y.'), STR_TO_DATE('15.05.2019.', '%d.%m.%Y.'), 10),
    (38, 38, "79787408178", STR_TO_DATE('16.09.1978.', '%d.%m.%Y.'), STR_TO_DATE('16.07.2018.', '%d.%m.%Y.'), 11),
    (39, 39, "88042605055", STR_TO_DATE('02.02.2002.', '%d.%m.%Y.'), STR_TO_DATE('10.03.2019.', '%d.%m.%Y.'), 10),
    (40, 40, "41079660133", STR_TO_DATE('13.11.1985.', '%d.%m.%Y.'), STR_TO_DATE('14.07.2016.', '%d.%m.%Y.'), 11);
