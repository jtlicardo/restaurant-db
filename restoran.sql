...
INSERT INTO racun (id, sifra, id_nacin_placanja, id_stol, id_djelatnik, vrijeme_izdavanja) VALUES
    ...
    (10, "000010", 1, 2, 7, STR_TO_DATE('20.12.2017. 10:00:00', '%d.%m.%Y. %H:%i:%s')),
    (11, "000011", 1, 5, 18, STR_TO_DATE('20.12.2017. 11:00:00', '%d.%m.%Y. %H:%i:%s')),
    (12, "000012", 1, 2, 7, STR_TO_DATE('20.12.2017. 12:00:00', '%d.%m.%Y. %H:%i:%s')),
    (13, "000013", 2, 6, 18, STR_TO_DATE('20.12.2017. 13:00:00', '%d.%m.%Y. %H:%i:%s')),
    (14, "000014", 1, 10, 18, STR_TO_DATE('20.12.2017. 14:00:00', '%d.%m.%Y. %H:%i:%s')),
    (15, "000015", 2, 1, 16, STR_TO_DATE('21.12.2017. 10:00:00', '%d.%m.%Y. %H:%i:%s')),
    (16, "000016", 1, 5, 16, STR_TO_DATE('21.12.2017. 11:00:00', '%d.%m.%Y. %H:%i:%s')),
    (17, "000017", 1, 2, 16, STR_TO_DATE('21.12.2017. 12:00:00', '%d.%m.%Y. %H:%i:%s')),
    (18, "000018", 1, 3, 7, STR_TO_DATE('21.12.2017. 13:00:00', '%d.%m.%Y. %H:%i:%s')),
    (19, "000019", 1, 4, 7, STR_TO_DATE('21.12.2017. 14:00:00', '%d.%m.%Y. %H:%i:%s')),
    (20, "000020", 1, 5, 7, STR_TO_DATE('21.12.2017. 15:00:00', '%d.%m.%Y. %H:%i:%s'));
