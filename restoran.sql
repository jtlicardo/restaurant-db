...
INSERT INTO nabava (id, id_dobavljac, opis, podmireno, datum) VALUES
    ...
    (4, 17, NULL, "N", STR_TO_DATE('28.02.2021.', '%d.%m.%Y.')),
    (5, 24, NULL, "N", STR_TO_DATE('28.02.2021.', '%d.%m.%Y.')), 
    (6, 30, NULL, "N", STR_TO_DATE('28.02.2021.', '%d.%m.%Y.')); -- meso
...
INSERT INTO otpis VALUES
    ...
    (3, STR_TO_DATE('15.03.2021.', '%d.%m.%Y.'), NULL),
    (4, STR_TO_DATE('15.04.2021.', '%d.%m.%Y.'), NULL),
    (5, STR_TO_DATE('15.07.2021.', '%d.%m.%Y.'), NULL);
...
INSERT INTO djelatnik_smjena VALUES
	...
	(51, 25, 5,STR_TO_DATE('15.12.2021.', '%d.%m.%Y.')),
	(52, 24, 4,STR_TO_DATE('16.12.2021.', '%d.%m.%Y.')),
	(53, 25, 5,STR_TO_DATE('16.12.2021.', '%d.%m.%Y.')),
	(54, 24, 4,STR_TO_DATE('17.12.2021.', '%d.%m.%Y.')),
	(55, 25, 5,STR_TO_DATE('17.12.2021.', '%d.%m.%Y.')),
	(56, 24, 4,STR_TO_DATE('18.12.2021.', '%d.%m.%Y.')),
	(57, 25, 5,STR_TO_DATE('18.12.2021.', '%d.%m.%Y.')),
	(58, 25, 4,STR_TO_DATE('19.12.2021.', '%d.%m.%Y.')),
	(59, 25, 5,STR_TO_DATE('19.12.2021.', '%d.%m.%Y.')),
	(60, 24, 4,STR_TO_DATE('20.12.2021.', '%d.%m.%Y.')),
	(61, 24, 5,STR_TO_DATE('20.12.2021.', '%d.%m.%Y.')),
	(62, 24, 4,STR_TO_DATE('21.12.2021.', '%d.%m.%Y.')),
	(63, 25, 5,STR_TO_DATE('21.12.2021.', '%d.%m.%Y.')),
    (64, 28, 6,STR_TO_DATE('15.12.2021.', '%d.%m.%Y.')),
	(65, 29, 6,STR_TO_DATE('16.12.2021.', '%d.%m.%Y.')),
	(66, 37, 6,STR_TO_DATE('18.12.2021.', '%d.%m.%Y.')),
	(67, 39, 6,STR_TO_DATE('19.12.2021.', '%d.%m.%Y.')),
	(68, 37, 6,STR_TO_DATE('20.12.2021.', '%d.%m.%Y.')),
	(69, 29, 6,STR_TO_DATE('21.12.2021.', '%d.%m.%Y.')),
    (70, 28, 3,STR_TO_DATE('15.12.2021.', '%d.%m.%Y.')),
    (71, 39, 3,STR_TO_DATE('15.12.2021.', '%d.%m.%Y.')),
    (72, 29, 4,STR_TO_DATE('15.12.2021.', '%d.%m.%Y.')),
    (73, 37, 4,STR_TO_DATE('15.12.2021.', '%d.%m.%Y.')),
	(74, 29, 3,STR_TO_DATE('16.12.2021.', '%d.%m.%Y.')),
    (75, 28, 3,STR_TO_DATE('16.12.2021.', '%d.%m.%Y.')),
    (76, 37, 4,STR_TO_DATE('16.12.2021.', '%d.%m.%Y.')),
    (77, 37, 3,STR_TO_DATE('17.12.2021.', '%d.%m.%Y.')),
    (78, 39, 4,STR_TO_DATE('17.12.2021.', '%d.%m.%Y.')),
    (79, 28, 4,STR_TO_DATE('17.12.2021.', '%d.%m.%Y.')),
    (80, 37, 3,STR_TO_DATE('18.12.2021.', '%d.%m.%Y.')),
    (81, 29, 3,STR_TO_DATE('18.12.2021.', '%d.%m.%Y.')),
    (82, 39, 4,STR_TO_DATE('18.12.2021.', '%d.%m.%Y.')),
	(83, 28, 4,STR_TO_DATE('18.12.2021.', '%d.%m.%Y.')),
    (84, 39, 3,STR_TO_DATE('19.12.2021.', '%d.%m.%Y.')),
    (85, 37, 4,STR_TO_DATE('19.12.2021.', '%d.%m.%Y.')),
    (86, 29, 4,STR_TO_DATE('19.12.2021.', '%d.%m.%Y.')),
    (87, 37, 3,STR_TO_DATE('20.12.2021.', '%d.%m.%Y.')),
    (88, 39, 3,STR_TO_DATE('20.12.2021.', '%d.%m.%Y.')),
    (89, 28, 4,STR_TO_DATE('20.12.2021.', '%d.%m.%Y.')),
    (90, 29, 4,STR_TO_DATE('20.12.2021.', '%d.%m.%Y.')),
    (91, 39, 3,STR_TO_DATE('21.12.2021.', '%d.%m.%Y.')),
    (92, 29, 3,STR_TO_DATE('21.12.2021.', '%d.%m.%Y.')),
    (93, 28, 4,STR_TO_DATE('21.12.2021.', '%d.%m.%Y.'));
