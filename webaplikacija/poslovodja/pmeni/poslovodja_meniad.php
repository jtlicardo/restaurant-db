    ...
    <?php
        ...
        <tbody style=''>";
            ...
            <td>".$redakmenija['aktivno']."</td>
                <td><a class='btn btn-info' href='poslovodja_stavkameni.php?dnaziv=".$redakmenija['naziv_stavke']."&operacija=1'>aktiviraj</a>
                    <a class='btn btn-info' href='poslovodja_stavkameni.php?dnaziv=".$redakmenija['naziv_stavke']."&operacija=2'>deaktiviraj</a></td>
                </tr>";
            }
            echo "
            </tbody>
            </table> </section><a class='btn btn-info' href='poslovodja_dodajmeni.php'>Dodaj</a>";?>
