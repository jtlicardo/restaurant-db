<?php
    ...
    //mora biti postavljena i osoba i adresa
    if (isset($_POST['sp_cateringzahtjev']) && isset($_SESSION['idadresa']) && isset($_SESSION['id'])) {
        ...
        //ukoliko osoba još nije bila narucitelj, unesuje se narucitelj
		...
		//provjera da osoba nije zabunom unijela dva cateringa
